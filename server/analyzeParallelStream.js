...
export const handleParallelAnalyzeStream = async (req, res) => {
  ...
  const finalResult = {
    ...
    analysis: {
      ...
      fengShui: mergedAnalysis.fengShui || '发展风水详细内容暂未生成。可先以居住环境整洁、采光通风、动线舒展为基本开运原则。',
      fengShuiScore: mergedAnalysis.fengShuiScore || 5,
      wealth: mergedAnalysis.wealth || '',
      wealthScore: mergedAnalysis.wealthScore || 5,
      marriage: mergedAnalysis.marriage || '婚姻情感详细内容暂未生成，建议结合现实沟通模式、责任分配与阶段运势综合判断。',
      marriageScore: mergedAnalysis.marriageScore || 5,
      health: mergedAnalysis.health || '健康分析详细内容暂未生成。建议保持规律作息，并结合个人体质进行定期体检。',
      healthScore: mergedAnalysis.healthScore || 5,
      family: mergedAnalysis.family || '六亲关系详细内容暂未生成，建议结合父母、伴侣、子女及合作关系的实际互动继续观察。',
      familyScore: mergedAnalysis.familyScore || 5,
      crypto: mergedAnalysis.crypto || '币圈交易详细内容暂未生成。投资风险较高，建议控制仓位、重视风控，避免情绪化交易。',
